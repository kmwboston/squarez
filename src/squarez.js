...
(function($){
    ...
    function define_Library(){
        ...
        //todo: make it so that they can put whatever they want on the faces??
        ...
        $.fn.squarez = function(options){
            ...
            var setup = function () {
                ...
                $(el).css({
                    '-webkit-transition': '-webkit-transform '+square.settings.transitionTime+'s',
                    '-moz-transition': '-moz-transform '+square.settings.transitionTime+'s',
                    '-o-transition': '-o-transform '+square.settings.transitionTime+'s',
                    'transition': 'transform '+square.settings.transitionTime+'s',
